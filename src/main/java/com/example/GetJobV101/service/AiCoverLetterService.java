...
public class AiCoverLetterService {
    ...
    public String getGuide(String content) {
        ...
        String rawGuide = (String) message.get("content");
        return rawGuide.replace("**", "");  // 마크다운 볼드 제거
    }
        ...
        Map<String, Object> requestBody = Map.of(
                ...
                "messages", List.of(
                        Map.of("role", "system", "content", """
                            너는 인사담당 면접관이야. 사용자의 자기소개서를 읽고, 실제 면접에서 물어볼 수 있는 질문을 5개에서 최대 10개까지 한국어로 만들어줘.
                            질문만 출력하고, 예시나 설명은 포함하지 마.
                        """),
                        Map.of("role", "user", "content", content)
                )
        );
